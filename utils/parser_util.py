...
def add_base_options(parser):
    ...
    group.add_argument("--device", default=7, type=int, help="Device id to use.")
...
def add_model_options(parser):
    ...
    group.add_argument("--cond_mode", default='text', choices=['text', 'action', 'no_cond', 'text_image'], type=str,
                       help="Conditioning mode. 'text_image' enables text+image driven generation.")
...
def add_training_options(parser):
    ...
    group.add_argument("--finetune_from", default='', type=str,
                       help="Path to pretrained checkpoint for fine-tuning (loads weights with strict=False).")
...
def add_sampling_options(parser):
    ...
    group.add_argument("--num_samples", default=30, type=int,
...
def add_generate_options(parser):
    ...
    group.add_argument("--scene_image", default='', type=str,
                       help="Path to a scene image for image-conditioned generation.")
    group.add_argument("--scene_category", default='', type=str,
                       help="Scene category name (e.g., 'road', 'kitchen') for random image selection from dataset.")
...
def generate_args():
    ...
    if (args.input_text or args.text_prompt) and cond_mode not in ('text', 'text_image'):
